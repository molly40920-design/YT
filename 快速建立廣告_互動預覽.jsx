...
/* 互動預覽環境無 Tailwind 編譯器，補上原檔用到的任意值類別（僅預覽用，原始碼 clean 版不含此段） */
const ARBITRARY_CSS = `
.text-\\[10px\\]{font-size:10px;line-height:.9rem}
.text-\\[11px\\]{font-size:11px;line-height:1rem}
.text-\\[13px\\]{font-size:13px;line-height:1.15rem}
.w-\\[15px\\]{width:15px}
.w-\\[560px\\]{width:560px}
...
export default function AdBuilderDemo() {
  ...
  return (
    <>
      ...
      {platform === "meta" ? <MetaFlow setPlatform={setPlatform} /> : <GoogleFlow setPlatform={setPlatform} />}
    </>
  );
}
